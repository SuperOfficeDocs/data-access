...
**External APIs** provide complete data access for both SuperOffice clients and online applications. These include SuperOffice COM APIs and the NetServer API landscape including SuperOffice web services.
